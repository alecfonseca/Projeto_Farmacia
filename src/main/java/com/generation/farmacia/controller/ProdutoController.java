...
public class ProdutoController {
	...
	// consulta preço inicial e preço final, e aparecer o que estiver entre
	// (BEETWEN) findByStartDateBetween
	...
	public ResponseEntity<List<Produto>> findByNomeLaboratorioProduto(@PathVariable String nome,
		...
		return ResponseEntity.ok(produtoRepository
				.findAllByNomeContainingIgnoringCaseAndLaboratorioContainingIgnoringCase(nome, laboratorio));
	}
}